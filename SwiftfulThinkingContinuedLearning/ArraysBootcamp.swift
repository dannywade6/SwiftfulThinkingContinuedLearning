...
class ArrayModificationViewModel: ObservableObject {
    ...
    func updateFilteredArray() {
        ...
        /*
         ...
         //        filteredArray = dataArray.sorted(by: { $0.points > $1.points }) // -> Shorthand
         */
        ...
        /*
         ...
         filteredArray = dataArray.filter({ $0.isVerified }) // Shorthand
        ...
        /*
         ...
         //        mappedArray = dataArray.map({ $0.name }) // -> Shorthand
         
         //        mappedArray = dataArray.compactMap({ user in
         //            return user.name
         //        }) // -> Long Hand
         
         mappedArray = dataArray.compactMap({ $0.name }) // -> Shorthand
